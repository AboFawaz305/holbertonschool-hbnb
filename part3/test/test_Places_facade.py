...
class testPlacesFacade(unittest.TestCase):
    ...
    def test_creat_valid_place(self):
        ...
        user_date ={"first_name":"aaaaa",
                    "last_name" :"sssss",
                    "email"     : "aaaa@gmail.com"}
        created_user = self.facade.create_user(user_date)
        place_data = {'title' : "a house",
    ...
    def test_get_all_places(self):
        user_date ={"first_name":"aaaaa",
                    ...
                    "email"     : "aaaa@gmail.com"}
        created_user = self.facade.create_user(user_date)
        place_data1 = {'title' : "a small house",
                      "description": "wow house",
                      "price" : 222,
                      "latitude" : 10.3423,
                      "longitude" : 43.4344 ,
    ...
    def test_update_place(self):
        ...
        user_date ={"first_name":"aaaaa",
                    ...
                    "email"     : "aaaa@gmail.com"}
        created_user = self.facade.create_user(user_date)
        place_data = {'title' : "a small house",
                      "description": "wow house",
                      "price" : 222,
                      "latitude" : 10.3423,
                      "longitude" : 43.4344 ,
        ...
        self.assertEqual(update_data['title'], self.facade.get_place(created_place.id).title)
        self.assertEqual(updated_place.title, self.facade.get_place(created_place.id).title)